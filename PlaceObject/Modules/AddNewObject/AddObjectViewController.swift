...
protocol AddObjectViewControllerDelegate: class {
...
class AddObjectViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == selectedVirtualObjectRow {
            delegate?.addObjectViewControllerDidDeselectObject(self)
        } else {
            delegate?.addObjectViewController(self, didSelectObjectAt: indexPath.row)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if object.thumbImage != nil {
            thumbnailImage = object.thumbImage
        } else {
            thumbnailImage = UIImage(named: "objects")!
        }
